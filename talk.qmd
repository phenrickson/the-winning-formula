...
But, there is enough going on in the world of AI/ML for network security that it's probably worth getting a mental model for what is going on.

. . .

I think the best I can reasonably do is [spark some level of interest]{.bg style="--col: #75BAFF"} in this area and where you should if you want to learn more.
...
I will list a [few books I think you should read]{.bg style="--col: #75ff9eff"} (and yes, some are textbooks).
...
So first, [I want to tell you a story]{.bg style="--col: #75BAFF"}
...
He should been examining *all passing sequences* and asking, **when do goals occur?**
...
He wrote a book, **The Winning Formula**, which advocated against **passing and possession** in favor of booting the ball upfield and shooting when given the opportunity.
...
## {background-image="images/talk/page_228.png" background-color="black" background-size="contain"}
...
You ask, what did this model get wrong?\
So that you can improve the next model.
...
If you train a model to simply look for the presence of code in every file, you can detect this and improve your ability to detect malware.
...
Alright, I promised that I was going to give you a [list of resources]{.bg style="--col: #75ff9eff"} to take on the dark and unending path into data science.
...
3) Become familiar with the [data science workflow]{.bg style="--col: #75BAFF"}
.\
